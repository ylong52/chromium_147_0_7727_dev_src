...
void RenderProcessHostImpl::PropagateBrowserCommandLineToRenderer(
  ...
  static const char* const kSwitchNames[] = {
      ...
      // Dchromium fork: VEM profile simulation switches propagated to renderer.
      "dchromium-fork-accept-languages",
      "dchromium-fork-architecture",
      // Audio/WebAudio and media-device surfaces remain host-native; VEM
      // audio/media switches must not cross into the renderer.
      "dchromium-fork-battery-charging",
      "dchromium-fork-battery-is-laptop",
      "dchromium-fork-battery-is-mobile",
      "dchromium-fork-battery-level-max",
      "dchromium-fork-battery-level-min",
      "dchromium-fork-bitness",
      "dchromium-fork-cpu-cores",
      "dchromium-fork-font-allowlist",
      "dchromium-fork-font-measure-grid-snap-px",
      "dchromium-fork-font-measure-jitter-factor",
      "dchromium-fork-font-per-etld-plus-one-enabled",
      "dchromium-fork-font-lang-binding-fallback-chain-b64",
      "dchromium-fork-form-factors",
      // Dchromium fork: Geolocation override (Phase 5 + Phase 5.b).
      "dchromium-fork-geo-accuracy",
      "dchromium-fork-geo-accuracy-range",  // Phase 5.b (2026-07-24)
      "dchromium-fork-geo-altitude",
      "dchromium-fork-geo-altitude-accuracy",
      "dchromium-fork-geo-heading",
      "dchromium-fork-geo-latitude",
      "dchromium-fork-geo-latitude-range",   // Phase 5.b (2026-07-24)
      "dchromium-fork-geo-longitude",
      "dchromium-fork-geo-longitude-range",  // Phase 5.b (2026-07-24)
      "dchromium-fork-geo-speed",
      "dchromium-fork-max-touch-points",
      "dchromium-fork-memory-mb",
      "dchromium-fork-model",
      // Dchromium fork: Permission override (Phase 5).
      "dchromium-fork-permission-geolocation",
      "dchromium-fork-prefers-reduced-motion",
      // Dchromium fork: Browser fingerprint overrides (Phase 5).
      "dchromium-fork-hide-webdriver",
      "dchromium-fork-platform",
      "dchromium-fork-platform-version",
      "dchromium-fork-screen-avail-height",
      "dchromium-fork-timezone",
      "dchromium-fork-touch-capable",
      "dchromium-fork-webgl-renderer",
      "dchromium-fork-webgl-vendor",
      "dchromium-fork-webgl-version",
      // Dchromium fork: WebGL variant switches (2026-07-27).
      "dchromium-fork-wow64",
      // Dchromium fork: Canvas 2D readback test noise (Phase P1, 2026-07-25).
      // SessionSeed must propagate Browser -> Renderer so that PerCanvasSalt
      // derivation is deterministic across the readback entry points.
      "canvas-fixed-seed",
      "canvas-test-noise-enabled",
      "canvas-test-noise-origins",
      "canvas-test-noise-version",
      "dchromium-fork-canvas-test-noise-enabled",
      "dchromium-fork-canvas-test-noise-seed",
      ...
      // Dchromium fork: CanvasAntiFraudSeedStore (Phase 2, 2026-07-26).
      // The anti-fraud seed is computed once in the browser process via
      // CanvasAntiFraudSeedStore::Resolve() and must propagate to renderer
      // so that all readback entry points share the same effective seed.
      "canvas-anti-fraud-seed",
      "dchromium-fork-canvas-test-noise-allowed-origins",
      // Dchromium fork: WebGL readback noise runtime gate (Phase W2, 2026-07-27).
      // Browser -> Renderer propagation so that every renderer process
      // participates in the same noise gate as the browser main process.
      "webgl-noise-enabled",
#if BUILDFLAG(IS_LINUX) && !BUILDFLAG(IS_CHROMEOS)
