...
class CONTENT_EXPORT MediaDevicesPermissionChecker {
 public:
  ...
  // Returns true if the --bypass-enumerate-devices-permission command-line
  // flag is present, indicating that the permission check for
  // enumerateDevices() should be bypassed and all device types should be
  // treated as authorized.
  static bool ShouldBypassEnumerateDevicesPermission();
